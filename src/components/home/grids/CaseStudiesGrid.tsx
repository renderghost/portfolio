import { Heading, Text, Card, CardImage, CardContent, Badge } from '@/components/ui'
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {latestCaseStudies.map((study, index) => (
        <Link key={study.slug} href={`/studies/${study.slug}`} className="group block h-full focus:outline-none focus:ring-2 focus:ring-bones-blue dark:focus:ring-bones-cyan focus:ring-offset-2 rounded-lg">
