    ...
    <>
      ...
      <div className="flex flex-col items-center w-full bg-whitesmoke">
        ...
        <div className="flex flex-col gap-32 items-start w-full max-w-[1920px] px-24 pt-32 pb-128">
          ...
          />
          <SectionQuote
            quote="Design is the process of going from an existing condition to a preferred one. Observe that there's no relationship to art."
          ...
          />
          <SectionText
            body="I've spent almost 20 years helping organisations close the gap between what users need, what technology can (and can't) do, and what a business aspires to achieve, then building products and services that satisfy all three. I believe nothing useful or long-lasting gets made any other way."
            size="md"
            usecase="2/3"
            showHeading={false}
            showLink={false}
          ...
          />
          <SectionText
            body="I believe that my role as a designer is to help people understand the status quo, and provide them with the tools, processes and knowledge to make postive and meaningful change. For me, that means having timely conversations, exposing complexity, testing risky assumptions, understanding constraints, and making good decisions collaboratively. I aim to leave every team more connected, informed and capable than when I joined them."
            size="md"
            usecase="2/3"
            showHeading={false}
            showLink={false}
